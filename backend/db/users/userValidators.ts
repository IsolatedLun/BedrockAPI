import Joi from "joi";
import { UserLoginForm, UserLoginWithOTPForm, UserOtpWithPvForm, UserRegistrationForm } from "../types";
...
export const userOtpWithPvValidator = Joi.object<UserOtpWithPvForm>({
